...
from bayes_chunk.utils.layer_stats import layer_stats
import argparse
...
def apply_memit_ARE_to_model(
    ...
    for k, data in enumerate(batch_data):
        ...
        # Add target vectors of the current sample to all_target_vectors
    ...
    for i, layer in enumerate(hparams.layers):
        ...
        for k, idxs in idxs_dict.items():
            ...
            for idx in idxs:
                # Get layer_in_ks of the current sample at the specified index
