...
from bayes_chunk.utils.globals import *
from bayes_chunk.utils.nethook import Trace, set_requires_grad
from bayes_chunk.utils.runningstats import CombinedStat, Mean, NormMean, SecondMoment, tally
...
def main():
    ...
    aa("--model_name", default="meta-llama/Meta-Llama-3-8B-Instruct")
